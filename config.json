{
  ...
  "whiteListMode": {
    "enable": false,
    "whiteListIds": ["61559946582981"],
    "notes": "if you enable this feature, only the ids in the whiteListIds section can use the bot"
  },
  "nickNameBot": "Your Baby 🧸",
  "prefix": "!",
  "database": {
    "type": "mongodb",
    "uriMongodb": "mongodb+srv://mdnirob11229:VyOD8j3UM9hRkzcl@cluster0.fsk0b.mongodb.net/SAIF-GOAT?retryWrites=true&w=majority&appName=Cluster0.",
